...
from models.noiseFiltering_models.waveform_model import SpectralVAE
...
if __name__ == "__main__":
    ...
    model = SpectralVAE(n_grains=n_grains, hop_size=hop_size, z_dim=LATENT_SIZE, normalize_ola=NORMALIZE_OLA, pp_chans=POSTPROC_CHANNELS, pp_ker=POSTPROC_KER_SIZE, l_grain=l_grain, n_cc=NUM_CC, n_freq=int(l_grain/2)+1)
